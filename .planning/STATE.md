...
The HCD channel-exhaustion blocker is RESOLVED (2026-07-07, half-duplex mic/speaker swap,
hardware-verified across 9+ consecutive RX/TX cycles) — CQ beaconing with real TX audio confirmed
working. Remaining for 05-01: confirm a full two-way QSO (not just beacon CQ) completes correctly.
